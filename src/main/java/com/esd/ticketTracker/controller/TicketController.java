...
import com.esd.ticketTracker.util.Role;
...
public class TicketController {
	...
	public String createTicket(@Validated @ModelAttribute("ticket") TicketDto ticketDto, BindingResult result,
			Model model) {
		if (result.hasErrors()) {
			model.addAttribute("ticket", ticketDto);
			return "admin/create_ticket";
	...
	public String updateTicket(@PathVariable long ticketId,
			@Validated @ModelAttribute TicketDto ticket, BindingResult result, Model model) {
		if (result.hasErrors()) {
	...
	public String viewPost(@PathVariable String ticketUrl, Model model) {
